    ...
    <Card className={classes.root} variant="outlined">
      ...
      <CardActions>
        <TextField
          ...
          onChange={(e) => {
            /* 
                    please move to a function and dont do complex functions inline
                    it will cause you problems from experience ;)
                    it will make your code cleaner and easier to debug
                    you can find many articles about why we shouldn't write complex function in the JSX
                */
